		...
		<div class="panel" style="display: block; width: 100%">
			<div class="panel-body panel-body-noheader panel-body-noborder" style="width: 100%; height: 100%;">
				<div class="dlg_content"> 
					<form:form modelAttribute="entity" id="form_addOrUpdate" action="edit" method="POST">
						<form:hidden path="id"/>
						<table class="table_list_1" width="100%">
							<tbody>
								<tr>
									<td class="t_l_1_title" width="40%">商户：</td>
									<td>
										${entity.merchant.count }
									</td>
								</tr>
								<tr>
									<td class="t_l_1_title">提成率：</td>
									<td>
										<input id="rate" name="rate" class="easyui-numberspinner" style="width:60px;" 
											value="${entity.rate * 100}" 
